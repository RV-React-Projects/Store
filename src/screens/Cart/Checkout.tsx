      ...
      {!cart ? (
        <div className="padding_div">
          ...
          <div className="mx-auto max-w-full justify-center px-6 md:flex md:space-x-6 xl:px-0">
            ...
            {/* <!-- Sub total --> */}
            <div className="mt-6 h-full rounded-lg bg-white dark:bg-gray-900 dark:text-gray-200 dark:shadow-sm dark:shadow-white p-6 shadow-md md:mt-0 md:w-1/3 grid gap-2 sticky top-0">
