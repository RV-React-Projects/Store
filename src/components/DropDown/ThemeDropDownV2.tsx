...
const ThemeDropDownV2 = (props: ThemeDropDownProps) => {
        ...
        >
          <label className="swap swap-rotate">
            <input
              ...
              onClick={() => switchTheme()}
            />
            <Svgs.Sun className="swap-on fill-current w-6 h-6" />
            <Svgs.Moon className="swap-off fill-current w-6 h-6" />
          </label>
        </button>
        <div
          ref={dropdownMenuRef}
...
export default memo(ThemeDropDownV2);
